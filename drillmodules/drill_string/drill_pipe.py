...
class DrillPipe:
    ...
    ----------
        ...
        - pipe_weight: Weight of the drill pipe in pounds
    ...
    def get_drag(
        ...
        # NOTE: Those tuples
        if delta_incli > 0:
            drag_val = self.string_force[0] * np.exp(
                -self.friction_co * abs(curr_azimuth)
            ) + self.buoyancy_factor[0] * self.pipe_weight * delta_length * (
    ...
    def _buckling_force(self, axial_force):
        ...
        buckling_force_val = -axial_force + (
    ...
    def get_side_cutting_factor(self):
        return 0.3  # NOTE: Not constant
