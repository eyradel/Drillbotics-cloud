# NOTE: NOT WELL IMPLEMENTED YET


"""
Base Drillstring module
"""
import numpy as np
import pandas as pd                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          
import math
...
class DrillStringObjBase:
    """
    Drill String Object Base Model: Represents a base
    for drill string and collars definations
    ...
    def __init__(
        ...
        self.string_force = (string_force,) #TODO check
        ...
        self.buoyancy_factor = (buoyancy_factor,) #TODO check
    ...
    def more_info(self):
        ...
        Prem Tube Tensile (lbs), pipe_weight, inner_diameter, outer_diameter

        """
        info = self.info
        info["pipe_weight"] = self.pipe_weight
        info["inner_diameter"] = self.inner_diameter
        info["outer_diameter"] = self.outer_diameter
    ...
    def tubing_clearance(self):
        return 0.5 * (self.hole_diameter - self.outer_diameter)
    ...
    def external_flow_area(self):
        return math.pi * self.outer_diameter**2 / 4
    ...
    def buoyed_pipe_weight(self):
        return np.abs(
            ...
            + 0.0408
            * (
                (self.inner_mud_weight * self.inner_diameter**2)
                - (self.outer_mud_weight * self.outer_diameter**2)
            )
        )
